...
activities = {
    ...
    "Soccer Team": {
        "description": "Team training and friendly matches for soccer players",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["maria@mergington.edu", "alex@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Practice basketball skills and play intra-school games",
    ...
    "Drama Club": {
        "description": "Develop acting skills and rehearse theatrical performances",
